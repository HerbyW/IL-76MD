...
var Startup = func{
	...
	interpolate("/controls/engines/engine[3]/starter", 0, 16, 1, 16, 0, 1);
	interpolate("/controls/engines/engine[1]/starter", 0, 33, 1, 16, 0, 1);
	interpolate("/controls/engines/engine[2]/starter", 0, 50, 1, 16, 0, 1);
	
	interpolate("/controls/engines/engine[0]/throttle", 0.13, 17);
	interpolate("/controls/engines/engine[3]/throttle", 0, 17, 0.13, 17);
	interpolate("/controls/engines/engine[1]/throttle", 0, 34, 0.13, 17);
	interpolate("/controls/engines/engine[2]/throttle", 0, 51, 0.13, 17);
